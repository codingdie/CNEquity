...
路径：`src/cnequity/adapters/eastmoney/`
...
[`datacenter_contracts.py`](../../../src/cnequity/adapters/eastmoney/datacenter_contracts.py)
...
可选 `cne derive sector_routing` 生成 EM×TDX 名称映射（**不参与** sector_bars 采集）。
